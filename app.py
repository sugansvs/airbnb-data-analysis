...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        # Business Question
        st.caption("Which property types have the highest prices by country and room type?")
    ...
    with tab2:
        ...
        # Business Question
        st.caption("Which room and bed types have more availability?")
    ...
    with tab3:
        ...
        st.caption("View listings in the selected price range and compare features for best value.")
        # ---------------- FILTER ----------------
        ...
        with tab5:
            ...
            # Business Question
            st.caption("What are the top-priced listings and their features?")
